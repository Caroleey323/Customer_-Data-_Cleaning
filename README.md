...
Organised data into two sheets: raw data and summary

Used COUNTIF formulas to calculate totals for each customer status

Created a clear summary of findings based on the data
